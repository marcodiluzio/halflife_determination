...
At present the input file are csv files resulting from TDCR elaboration performed with package [TDCRPy]([https://pages.github.com/](https://github.com/RomainCoulon/TDCRPy))
